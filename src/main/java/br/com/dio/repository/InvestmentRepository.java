...
public class InvestmentRepository {
    ...
    public InvestmentWallet deposit(final String pix, final long funds) {
        ...
        List<Money> moneyFromAccount = wallet.getAccount().reduceMoney(funds);
        wallet.addMoney(moneyFromAccount);
        return wallet;
    }
    ...
    public InvestmentWallet withdraw(final String pix, final long funds) {
        ...
        List<Money> moneyFromInvestment = wallet.reduceMoney(funds);
        wallet.getAccount().addMoney(moneyFromInvestment);
    ...
    public InvestmentWallet findWalletByAccountPix(final String pix) {
        return wallets.stream()
                ...
                .findFirst()
                .orElseThrow(
                        () -> new InvestmentNotFoundException("A carteira não foi encontrada para o PIX informado")
                );
    }
